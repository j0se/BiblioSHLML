...
(function(exports) {
    ...
    exports.ReaderControl.prototype = {
        ...
        bindEvents: function() {
            ...
            me.$annotEditPopup.find('#editStyleButton').on('click', function() {
                ...
                if (selectedAnnotations.length === 1) {
                    ...
                    setEditMode(window.ControlUtils.getDefaultToolEditingMode(annotation));
            ...
            var advancedColors = window.ControlUtils.getAdvancedToolColors();
            ...
            $selectAddColor.on('click', function() {
                if (!$(this).hasClass('disabled')) {
                    ...
                    window.ControlUtils.addToolColor(annot, selectedColorPicker, selectedColor);
                ...
                if (color) {
                    ...
                    if (isRemovingColors) {
                        ...
                        if (colorName !== 'transparent') {
                            window.ControlUtils.removeToolColor(annotation, annotationProperty, colorName);
                            $element.remove();
                        }
            ...
            function selectTab(colorType) {
                ...
                var $tab, colors;
                var toolColors = window.ControlUtils.getToolColors(annot);
            ...
            $basicPropertyEdit.on('click', function() {
                ...
                window.ControlUtils.setDefaultToolEditingMode(window.ControlUtils.getSelectedAnnotation(), editMode.basic);
            });
            ...
            $advancedPropertyEdit.on('click', function() {
                ...
                window.ControlUtils.setDefaultToolEditingMode(window.ControlUtils.getSelectedAnnotation(), editMode.advanced);
                setTransparentColorVisibility();
            });
        ...
        onResize: function() {
            ...
            if ((screenHeight < me.lastHeight) && !widthChanged && me.$defaultMenuContext.css('display') !== 'none') {

...
class SearchDocumentController extends Controller
{
    ...
    {
        return $this->render('SHLMLCoreBundle:Search:index.html.twig');
    }
    ...
    public function singleSearchPageAction(Request $request)
    {
        ...
        return $this->render('SHLMLCoreBundle:Search:singleSearch.html.twig', array( "searchedWord" => $word, "chosenDoc" => $doc , "wordList" => $wordList, "documentList" => $documentList )); //, array('posts' => $posts));
    }
    ...
    public function multipleSearchPageAction(Request $request)
    {
        ...
        return $this->render('SHLMLCoreBundle:Search:multipleSearch.html.twig', array( "fullSearch" => $word, "wordList" => $wordList, "documentList" => $documentList)); //, array('posts' => $posts));
    }
}
